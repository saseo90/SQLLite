...
public class MainPanController {
	...
	// 사이드 컬럼
	@FXML
	private TableView<DefaultTableInfo> sideTableColumns;
	@FXML
	private TableColumn<DefaultTableInfo, String> sideColColumnName;
	@FXML
	private TableColumn<DefaultTableInfo, String> sideColDateType;
	@FXML
	private TableColumn<DefaultTableInfo, String> sideColNullable;
	@FXML
	private TableColumn<DefaultTableInfo, String> sideColDateDefault;
	@FXML
	private TableColumn<DefaultTableInfo, String> sideColColumnId;
	@FXML
	private TableColumn<DefaultTableInfo, String> sideColComments;
	// 사이드 컬럼추가 영역
	@FXML
