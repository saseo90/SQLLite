...
import lite.sql.utility.poi.outputexcel.PoiInput;
...
import lite.sql.backdoor.dao.SessionDaoImpl;
import lite.sql.backdoor.session.SessionThread;
import lite.sql.frontdoor.copyRight.CopyRightThread;
 ...
 */
public class MainPanController implements Initializable {
	// 디자인 - 컨테이너 영역
	@FXML
	...
	@FXML
	private Button btnNonAceess;

	@FXML
	private Button btnManageSesi;
	...
	// 상단2
	@FXML
	private TextField textfieldAccessUseId;
	@FXML
	private TextField textfieldAccessUseIp;
	@FXML
	private TextField textfieldAccessDriver;

	// 사이드 영역 시작
	// 사이드 버튼바
	@FXML
	private ToolBar sideToolbarMenu;
	@FXML
	private Button btnSelectTables;
	// 사이드 테이블
	@FXML
	private StackPane paneStack;
	// 사이드 출력된 컬럼의 테이블 이름
	@FXML
	private Label sideLabelTableName;
	// 사이드 컬럼
	@FXML
	private TableView<ColType> sideTableColumns;
	@FXML
	private TableColumn<ColType, String> sideColColumnName;
	@FXML
	private TableColumn<ColType, String> sideColDateType;
	@FXML
	private TableColumn<ColType, String> sideColNullable;
	@FXML
	private TableColumn<ColType, String> sideColDateDefault;
	@FXML
	private TableColumn<ColType, String> sideColColumnId;
	@FXML
	private TableColumn<ColType, String> sideColComments;
	// 사이드 컬럼추가 영역
	@FXML
	private Label sidLabelAppendCol;

	@FXML
	private TextField sidTextFieldColName;

	@FXML
	private ComboBox<String> sidComboDateType;

	@FXML
	private TextField sidTextFieldDefault;

	@FXML
	private Button btnAppendCol;

	// 컨텐트영역 시작
	// 컨텐트 paneUp 영역
	@FXML
	private TabPane contentTabpaneUp;
	@FXML
	private Tab tabBase;
	@FXML
	...
	@FXML
	private TextArea textareaSession;
	// 컨텐트 버튼바
	@FXML
	private ToolBar contentToolbarWork;
	@FXML
	private Button btnRun;

	@FXML
	private Button btnRunAll; // 전체스크립트 실행

	@FXML
	private Button btnRepairData;
	@FXML
	private Button btnSaveAccel;
	@FXML
	private Button btnSaveSql;
	@FXML
	private Button btnLordAccel;
	@FXML
	private Button btnLordSql;
	@FXML
	private Button btnOpeneRepairContentsheet;

	// 컨텐트 paneDouwn 영역 시작
	@FXML
	private TabPane contentTabpaneDown;
	@FXML
	private Tab tabReportSelect;
	@FXML
	private TableView<Object> tableReportSelect;
	@FXML
	private Tab tabReportErrorScript;
	@FXML
	private TextArea textareaReportErrorScript;
	@FXML
	private Tab tabRepairData;
	@FXML
	private AnchorPane scrollerRepairData;
	@FXML
	private FlowPane flowerRepairData;

	// 하단 - 메시지
	@FXML
	private Label downLabelMessage;

	// bacgroundPane content영역 높이조절
	@FXML
	private Button btnCloseRepairContentsheet;
	@FXML
	private Pane panBacgraound;
	@FXML
	private ScrollBar scrollContentsheet;
	@FXML
	private CheckBox chekBaseContentsheet;
	@FXML
	private Button btnTexCel;
	...
	@FXML
	private ScrollBar scrollWidth;

	// 쿼리문 자동완성 실행버튼
	@FXML
	private Button btnSelTxt;
	@FXML
	private Button btnUpdateTxt;
	@FXML
	private Button btnInsTxt;
	@FXML
	private Button btnDelTxt;
	@FXML
	private Button btnAltTxt;
	@FXML
	private Button btnCreTxt;
	@FXML
	private Button btnDropTxt;
    @FXML
    private Button btnEpilogue;
	...
	public void handleButtonAction(Event event) {
		try {
			Parent home_page_parent = FXMLLoader.load(getClass().getResource(
					"/lite/sql/frontdoor/loginPage/login.fxml"));
